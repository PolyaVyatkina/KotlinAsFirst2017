...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("16.08.1", dateStrToDigit("16 августа 1"))
    }
    ...
    fun bestLongJump() {
        ...
        assertEquals(2147483647, bestLongJump("2147483647 2147483647 0     -  - - - - - 897283079 - 835705591"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Хлеб -39.9; Курица 135.0"))
    }
